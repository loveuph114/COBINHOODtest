 ...
 */
class TickerListViewHolder constructor(itemView : View) : TickerViewHolder<Model.Ticker>(itemView) {

    private var tickerPairIdText : TextView = itemView.findViewById(R.id.ticker_list_trading_pair_id)
    private var percentageText : TextView = itemView.findViewById(R.id.ticker_list_percentage)
    private var lastTradePriceText: TextView = itemView.findViewById(R.id.ticker_list_last_trade_price)
    private val selectedImg : ImageView = itemView.findViewById(R.id.ticker_list_selected);
